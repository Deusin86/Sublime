							...
							<nav class="main_nav">
								<ul>
									...
									<li class="hassubs">
										...
										<ul>
											<li><a href="tecnologiaa.php">Tecnologia</a></li>
					...
					<div class="product_grid">
						...
						<?php
						    include 'ligacao/conn.php';
								$idx = $_GET['Categoria'];
						  	$dados = (mysqli_query($conn,"SELECT id_produto, categoria, nome, preco_mercado, desconto, quantidade, descricao FROM produtos where categoria like '$idx'"));
